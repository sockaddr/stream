...
class KeyboardModels:
    ...
    def __init__(self):
        ...
        self._modelDict = {
            ...
            ### rhbz#606820 'ar-azerty'               : [_('keyboard|Arabic (azerty)'), 'ara,us', 'pc105', 'azerty', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ar-azerty-digits'        : [_('keyboard|Arabic (azerty/digits)'), 'ara,us', 'pc105', 'azerty_digits', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ar-digits'               : [_('keyboard|Arabic (digits)'), 'ara,us', 'pc105', 'digits', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ar-qwerty'               : [_('keyboard|Arabic (qwerty)'), 'ara,us', 'pc105', 'qwerty', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ar-qwerty-digits'        : [_('keyboard|Arabic (qwerty/digits)'), 'ara,us', 'pc105', 'qwerty_digits', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            'be-latin1'               : [_('keyboard|Belgian (be-latin1)'), 'be', 'pc105', '', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ben'                      : [_('keyboard|Bengali (Inscript)'), 'in,us', 'pc105', 'ben', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ben-probhat'             : [_('keyboard|Bengali (Probhat)'), 'in,us', 'pc105', 'ben_probhat', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ...
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'dev'                     : [_('keyboard|Devanagari (Inscript)'), 'dev,us', 'pc105', '', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
           'dvorak'                   : [_('keyboard|Dvorak'), 'us', 'pc105', 'dvorak', ''],
            ...
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'guj'                     : [_('keyboard|Gujarati (Inscript)'), 'in,us', 'pc105', 'guj', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'gur'                     : [_('keyboard|Punjabi (Inscript)'), 'gur,us', 'pc105', '', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ...
            ### rhbz#606820 'ie'                      : [_('keyboard|Irish'), 'ie', 'pc105', '', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ...
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ro-std'                  : [_('keyboard|Romanian Standard'), 'ro', 'pc105', 'std', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ro-cedilla'                  : [_('keyboard|Romanian Cedilla'), 'ro', 'pc105', 'cedilla', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'ro-std-cedilla'                  : [_('keyboard|Romanian Standard Cedilla'), 'ro', 'pc105', 'std_cedilla', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ...
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'tj'                      : [_('keyboard|Tajik'), 'tj', 'pc105', '', ''],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'tml-inscript'            : [_('keyboard|Tamil (Inscript)'), 'in,us', 'pc105', 'tam', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
            ### rhbz#606820 'tml-uni'                 : [_('keyboard|Tamil (Typewriter)'), 'in,us', 'pc105', 'tam_TAB', 'grp:shifts_toggle,grp_led:scroll'],
            # Translators: the word before the bar is just context and
            # doesn't need to be translated. Only after will be translated.
